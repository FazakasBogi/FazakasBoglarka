...
const WEEE_RECYCLING_PATHS = [
  WEEE_RECYCLING_PATH,
  "data/weee_recycling%20rate.csv",
  "data/weee_recycling rate.csv",
  "./data/weee_recycling%20rate.csv",
  "./data/weee_recycling rate.csv",
];
const EUROBAROMETER_PATHS = [
  EUROBAROMETER_PATH,
  "data/cleaned/eurobarometer_sp550_ro_nl_eu.csv",
  "./data/cleaned/eurobarometer_sp550_ro_nl_eu.csv",
];
